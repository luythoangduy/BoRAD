...
class cfg(cfg_common, cfg_dataset_default, cfg_model_rd):
    ...
    def __init__(self):
        ...
        # KEY CHANGE: Use rd_lgc_byol model with BYOL architecture
        self.model = Namespace()
        self.model.name = 'rd_lgc_byol'  # Changed from 'rd_lgc'
        ...
        self.loss.loss_terms = [
            ...
            dict(type='PrototypeBYOLLoss', name='proto', lam=1.0, n_prototypes=10, feat_dim=2048, lam_spatial=1.0, lam_global=1.0),
        ]
