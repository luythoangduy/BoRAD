...
class cfg(cfg_common, cfg_dataset_default, cfg_model_rd):
    """Config for BorAD on BTAD dataset."""
    ...
    def __init__(self):
        ...
        self.model.kwargs = dict(
            ...
            momentum=0.99, momentum_schedule='linear',
            momentum_start=0.99, momentum_end=0.999
        )
        ...
        # ==> trainer
        self.trainer.name = 'RDLGCBYOLTrainer'
